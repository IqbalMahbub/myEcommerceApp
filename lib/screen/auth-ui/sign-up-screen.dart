...
import '../../utilis/app-constant.dart';
      ...
      return Scaffold(
        ...
        body: Container(
          child: Column(
            children: [
              isKeyboardVisible
                  ? Text("Welcome to CraftyBay",style: TextStyle(fontSize:30),)
                  : Column(
                      children: [
                    ...
                    decoration: InputDecoration(
                      ...
                      contentPadding: EdgeInsets.only(top: 2.0, left: 8.0),
                        enabledBorder: OutlineInputBorder(
                          ...
                          borderSide: BorderSide(color: AppConstant.appScendoryColor, width: 1.5),
                        ),
